"""
EducationalContent model for description module
...
class EducationalContent(Base):
    ...
    format = Column(String)('article', 'video', 'guide', 'checklist')
    ...
    def __repr__(self):
        return f"<EducationalContent(id={self.id})>"
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "EducationalContent":
        ...
        Returns:
            EducationalContent: Model instance
        """
        return cls(**data)
