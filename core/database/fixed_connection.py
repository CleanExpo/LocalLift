...
try:
    ...
    # Add special handling for passwords with special characters
    # This is important because @ symbols in passwords can cause connection issues
    if '@' in db_url:
        # Ensure @ in password is properly encoded in the DATABASE_URL
        print("--- Detected potential special character in connection string, ensuring proper URL encoding")
